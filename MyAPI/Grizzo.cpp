...
namespace My
{
	...
	void Grizzo::Initialize()
	{
		...
		mAnimator->CreateAnimation(L"RightMove", mGrizzo, Vector2::Zero, 10, 10, 4, Vector2::Zero, 0.3);
		mAnimator->CreateAnimation(L"LeftMove", mGrizzo, Vector2(0.0f, 100.0f), 10, 10, 4, Vector2::Zero, 0.3);
